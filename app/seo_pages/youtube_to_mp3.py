page_data = {
    ...
    "description": ('Convert YouTube videos to MP3 online free. Download high-quality audio from YouTube videos, music, podcasts and lectures. Works on Android, iPhone, Windows '
     'and Mac. No signup required.'),
...
""",
    "steps": [   {'number': 1, 'title': 'Copy the YouTube Video URL', 'desc': 'Open YouTube, locate the video, music track, podcast or lecture and copy the URL.'},
        {'number': 2, 'title': 'Paste the Link', 'desc': 'Paste the YouTube URL into the converter input box.'},
        {'number': 3, 'title': 'Process the Video', 'desc': 'The system analyzes the video and extracts the available audio stream.'},
    ...
    "related_searches": ('\n'
     ...
     '</ul>\n'
     '\n'),
    "faqs": [   {'question': 'Is YouTube to MP3 conversion free?', 'answer': 'Yes, the converter can be used without registration or subscription.'},
        {'question': 'Can I convert YouTube Shorts to MP3?', 'answer': 'Yes, supported Shorts URLs can be processed.'},
        {'question': 'What is the highest MP3 quality available?', 'answer': '320kbps is generally considered the highest standard MP3 bitrate.'},
        {'question': 'Can I use this converter on Android?', 'answer': 'Yes, Android phones and tablets are supported.'},
        {'question': 'Can I use it on iPhone?', 'answer': 'Yes, Safari on iPhone works well.'},
        {'question': 'Does it work on Windows PCs?', 'answer': 'Yes, all major desktop browsers are supported.'},
        {'question': 'Do I need to install software?', 'answer': 'No, everything works inside your browser.'},
        {'question': 'Can I convert podcasts?', 'answer': 'Yes, podcasts and spoken-word content are supported.'},
        {'question': 'Can I convert music videos?', 'answer': 'Yes, public music videos can be processed.'},
